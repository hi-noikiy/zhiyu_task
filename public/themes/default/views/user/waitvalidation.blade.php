            ...
            <div class="row">
                <div class="col-xs-12 loginbrand">
                    <div class="pull-left p-space">
                        {{--<a href="javascript:;" class="pull-left hidden-480"><img src="{!! Theme::asset()->url('images/sign-logo.png') !!}" alt="职鱼" class="img-responsive"></a>--}}
                        <a href="{!! CommonClass::homePage() !!}" class="pull-left hidden-480">
                            {{--<img src="{!! url(Theme::get('site_config')['site_logo_1'])!!}" alt="职鱼" class="img-responsive">--}}
                            @if(Theme::get('site_config')['site_logo_1'])
                                <img src="{!! url(Theme::get('site_config')['site_logo_1'])!!}" alt="职鱼" class="img-responsive login-logo">
                            @else
                                <img src="{!! Theme::asset()->url('images/sign-logo.png') !!}" alt="职鱼" class="img-responsive login-logo">
                            @endif
                        </a>
