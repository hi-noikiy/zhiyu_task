                ...
                <div style="width:650px;text-align:left;font:12px/15px simsun;color:#000;background:#fff;">
                    <div style="background: url('{!! url('themes/default/assets/images/sign-emailbg.png') !!}') no-repeat;min-height: 474px;padding: 43px;">
                        <div style="text-align: center;margin: 12px 0 50px 0"><a href="javascript:;">
                                @if(Theme::has('site_config') && Theme::get('site_config')['site_logo_1'])
                        ...
                        <div style="font-size: 14px;color: #515151;">
                            ...
                            <p>Email:
                                @if(Theme::has('site_config') && Theme::get('site_config')['Email'])
                                    {!! Theme::get('site_config')['Email'] !!}
                                @else
                                    admin@163.com
                                @endif</p>
                        </div>
